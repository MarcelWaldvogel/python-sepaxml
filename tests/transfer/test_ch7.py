  ...
  <CstmrCdtTrfInitn>
    ...
    <PmtInf>
      ...
      <CdtTrfTxInf>
        ...
        <CdtrAcct>
          <Id>
            <IBAN>CH1122222000000000000</IBAN>
          </Id>
        </CdtrAcct>
        <RmtInf>
...
def test_two_ch7_debits(strf_ch7):
    payment1 = {
    ...
    payment2 = {
        "name": "Test du Test",
        "IBAN": "CH1122222000000000000",
        "amount": 5000,
        "execution_date": datetime.date.today(),
        "description": "Test transaction2"
    }

    strf_ch7.add_payment(payment1)
    strf_ch7.add_payment(payment2)
    xmlout = strf_ch7.export()
    print(xmlout)
